...
export default function TeacherStudentInternshipDetail() {
                      ...
                      <tbody>
                        {
                          workday.map((workday, index) => (
                            <tr key={index}>
                              ...
                              <td>
                                <Link className='btn btn-outline-primary mx-2' to={`/teacher/student/${id}/internship/${id2}/workday/${workday.id}`}>Ver Más</Link>
