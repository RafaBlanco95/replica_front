    ...
    useEffect(() => {
        ...
        const fetchUserData = async () => {
            try {
                ...
                const response = await axios.get(`https://replicarepo-production.up.railway.app/replica/v1/students/username/${username}`, {
                    headers: {
            ...
            <div className="container">
                <div className='row mb-5'>
                    <div className='col-md-6 offset-md-3 border rounded p-4 mt-5 shadow'>
                        <h2 className='text-center m-4'>Perfil de Alumno</h2>
                        <div className='card'>
                        ...
                        <Link className="btn btn-primary mx-2" to={`/edit_student/${userData?.data?.id}`}>Editar</Link>
